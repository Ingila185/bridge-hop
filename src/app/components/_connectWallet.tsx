...
export default function ConnectWallet()
{
    ...
    const [wallet, setWallet] = React.useState(initialState)  /* New */
    ...
    <div className=" mx-auto pt-20  w-full max-w-md max-h-full justify-center items-center ">
        <div className=" bg-dreamBlack rounded-lg shadow justify-center items-center border-2 border-cardBorder">
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 
                dark:hover:text-white" onClick={()=>{setShowModal(false)}}>
